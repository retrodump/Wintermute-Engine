...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	if (!m_wndWorkSpace.Create (_T("Scene"), this, CSize (228, 250),
	...
	if (!m_wndProperty.Create (_T("Properties"), this, CSize (228, 100),
	...
	if (!m_wndOutput.Create (_T("Output"), this, CSize (150, 100),
...
void CMainFrame::OnActivate(UINT nState, CWnd* pWndOther, BOOL bMinimized) 
{
	...
	((CSceneEditApp*)AfxGetApp())->m_Active = nState != WA_INACTIVE;
