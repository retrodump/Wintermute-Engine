namespace SampleApp
{
	partial class FolderBrowser
	{
		...
		private void InitializeComponent()
		{
			...
			this._treeView.LineColor = System.Drawing.Color.Red;
			...
			this._treeView.NodeControls.Add(this.nodeIcon1);
			...
			this._treeView.ColumnWidthChanged += new System.EventHandler<Aga.Controls.Tree.TreeColumnEventArgs>(this._treeView_ColumnWidthChanged);
			// 
			// treeColumn1
			// 
			...
			this.nodeIcon1.IncrementalSearchEnabled = false;
			this.nodeIcon1.ParentColumn = this.treeColumn3;
			// 
			// FolderBrowser
			// 
