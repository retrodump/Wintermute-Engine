namespace DeadCode.WME.WindowEdit
{
	partial class FrmAbout
	{
		...
		private void InitializeComponent()
		{
			...
			this.LblProgram.Size = new System.Drawing.Size(74, 13);
			this.LblProgram.TabIndex = 1;
			this.LblProgram.Text = "WindowEdit";
			// 
			// LblVersion
			// 
			...
			this.BtnOK.Location = new System.Drawing.Point(163, 251);
			...
			// PicLogo
			// 
			this.PicLogo.Image = global::DeadCode.WME.WindowEdit.Properties.Resources.logo100;
			this.PicLogo.Location = new System.Drawing.Point(12, 118);
			...
			this.label3.Text = "See the documentation for the list of third party products used in this software." +
				"";
			// 
			// FrmAbout
			// 
