...
//////////////////////////////////////////////////////////////////////////
CScValue::CScValue(CBGame* inGame, char* Val):CBBase(inGame)
{
	m_Type = VAL_STRING;
	m_ValString = NULL;
	SetStringVal(Val);
...
//////////////////////////////////////////////////////////////////////////
void CScValue::SetString(char* Val)
{
	if(m_Type==VAL_VARIABLE_REF){
...
//////////////////////////////////////////////////////////////////////////
void CScValue::SetStringVal(char *Val)
{
	if(m_ValString) delete [] m_ValString;
...
// IWmeValue
//////////////////////////////////////////////////////////////////////////
int CScValue::GetValInt()
{
	return GetInt();
}

//////////////////////////////////////////////////////////////////////////
const char* CScValue::GetValString()
{
	return GetString();
}

//////////////////////////////////////////////////////////////////////////
double CScValue::GetValFloat()
{
	return GetFloat();
}

//////////////////////////////////////////////////////////////////////////
bool CScValue::GetValBool()
{
	return GetBool();
}
...
//////////////////////////////////////////////////////////////////////////
bool CScValue::SetVal(int Value)
{
	SetInt(Value);
	return true;
}
...
//////////////////////////////////////////////////////////////////////////
bool CScValue::SetVal(const char* Value)
{
...
//////////////////////////////////////////////////////////////////////////
bool CScValue::SetVal(double Value)
{
	SetFloat(Value);
	return true;
}
...
//////////////////////////////////////////////////////////////////////////
bool CScValue::SetVal(bool Value)
{
	SetBool(Value);
	return true;
}
...
//////////////////////////////////////////////////////////////////////////
bool CScValue::SetVal(IWmeObject* Value)
{
	SetNative((CBScriptable*)Value);
	return true;
}

//////////////////////////////////////////////////////////////////////////
bool CScValue::SetVal(IWmeValue* Value)
{
	SetValue((CScValue*)Value);
	return true;
}

//////////////////////////////////////////////////////////////////////////
bool CScValue::SetVal()
{
	SetNULL();
	return true;
}
...
//////////////////////////////////////////////////////////////////////////
bool CScValue::IsValNative()
{
	return IsNative();
}

//////////////////////////////////////////////////////////////////////////
bool CScValue::IsValObject()
{
	return IsObject();
}
...
//////////////////////////////////////////////////////////////////////////
IWmeValue* CScValue::GetProperty(const char* PropName)
{
	return GetProp((char*)PropName);
}
...
//////////////////////////////////////////////////////////////////////////
bool CScValue::SetProperty(const char* PropName, IWmeValue* Value)
{
	return SUCCEEDED(SetProp((char*)PropName, (CScValue*)Value));
}
