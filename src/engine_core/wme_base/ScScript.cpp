...
//////////////////////////////////////////////////////////////////////////
HRESULT CScScript::CreateThread(CScScript *Original, DWORD InitIP, char* EventName)
{
	Cleanup();
...
//////////////////////////////////////////////////////////////////////////
HRESULT CScScript::CreateMethodThread(CScScript *Original, char* MethodName)
{
...
HRESULT CScScript::ExecuteInstruction()
{
	...
	case II_CMP_EQ:
		...
		if((op1->IsNULL() && !op2->IsNULL()) || (!op1->IsNULL() && op2->IsNULL())) m_Operand->SetBool(false);
			...
			m_Operand->SetBool(_stricmp(op1->GetString(), op2->GetString())==0);
		}
...
//////////////////////////////////////////////////////////////////////////
DWORD CScScript::GetFuncPos(char *Name)
{
...
//////////////////////////////////////////////////////////////////////////
DWORD CScScript::GetMethodPos(char *Name)
{
...
HRESULT CScScript::Sleep(DWORD Duration)
{
	...
	if(Game->m_State == GAME_FROZEN){
		m_WaitTime = timeGetTime() + Duration;
		m_WaitFrozen = true;
	}
	else{
...
//////////////////////////////////////////////////////////////////////////
CScScript* CScScript::InvokeEventHandler(char *EventName, bool Unbreakable)
{
...
#ifdef _UNICODE
	wchar_t* DllNameW = new wchar_t[strlen(Function->dll_name)+1];
	MultiByteToWideChar(CP_ACP, 0, Function->dll_name, -1, DllNameW, strlen(Function->dll_name)+1);
	HMODULE hDll = LoadLibrary(DllNameW);
	delete [] DllNameW;
#else
...
// IWmeScript
//////////////////////////////////////////////////////////////////////////
const char* CScScript::GetFilename()
{
	return m_Filename;
}

//////////////////////////////////////////////////////////////////////////
int CScScript::GetCurrentLine()
{
	return m_CurrentLine;
}

//////////////////////////////////////////////////////////////////////////
void CScScript::ReportRuntimeError(const char* Description)
{
	RuntimeError((char*)Description);
}

//////////////////////////////////////////////////////////////////////////
IWmeValue* CScScript::GetVariable(const char* VarName)
{
	if(m_Globals->PropExists((char*)VarName)) return m_Globals->GetProp((char*)VarName);
	else return NULL;
}

//////////////////////////////////////////////////////////////////////////
bool CScScript::SetVariable(const char* VarName, int Value)
{
	if(m_Globals->PropExists((char*)VarName))
	{
		CScValue* Var = m_Globals->GetProp((char*)VarName);
		Var->SetInt(Value);
		return true;
	}
	else return false;
...
//////////////////////////////////////////////////////////////////////////
bool CScScript::SetVariable(const char* VarName, const char* Value)
{
	if(m_Globals->PropExists((char*)VarName))
	{
		CScValue* Var = m_Globals->GetProp((char*)VarName);
		Var->SetString((char*)Value);
		return true;
	}
	else return false;
}
...
//////////////////////////////////////////////////////////////////////////
bool CScScript::SetVariable(const char* VarName, double Value)
{
	if(m_Globals->PropExists((char*)VarName))
	{
		CScValue* Var = m_Globals->GetProp((char*)VarName);
...
//////////////////////////////////////////////////////////////////////////
bool CScScript::SetVariable(const char* VarName, bool Value)
{
	if(m_Globals->PropExists((char*)VarName))
	{
		CScValue* Var = m_Globals->GetProp((char*)VarName);
...
//////////////////////////////////////////////////////////////////////////
bool CScScript::SetVariable(const char* VarName, IWmeObject* Value)
{
	if(m_Globals->PropExists((char*)VarName))
	{
		CScValue* Var = m_Globals->GetProp((char*)VarName);
		Var->SetNative((CBObject*)Value);
		return true;
	}
	else return false;
}
...
//////////////////////////////////////////////////////////////////////////
bool CScScript::SetVariable(const char* VarName, IWmeValue* Value)
{
	if(m_Globals->PropExists((char*)VarName))
	{
		CScValue* Var = m_Globals->GetProp((char*)VarName);
		Var->Copy((CScValue*)Value, true);
		return true;
	}
	else return false;
}
...
//////////////////////////////////////////////////////////////////////////
bool CScScript::SetVariable(const char* VarName)
{
	if(m_Globals->PropExists((char*)VarName))
	{
		CScValue* Var = m_Globals->GetProp((char*)VarName);
